...
export function StanceTimer({
  ...
  return (
    <div className="rounded-[var(--radius-control)] border-2 border-dashed border-hairline bg-surface p-3 text-center">
      <p className="text-xs font-extrabold uppercase tracking-wide text-ink-2">
        Chrono — {stance?.pinyin ?? stanceKey}
      </p>
      <p className="mt-1 text-4xl font-extrabold tabular-nums">{formatSeconds(seconds)}</p>

      <div className="mx-auto mt-2 h-2 max-w-xs overflow-hidden rounded-full bg-raised">
        <div
      ...
      <div className="mt-3 flex justify-center gap-2">
        ...
        <Button ref={saveRef} variant="secondary" onClick={save} disabled={seconds === 0}>
          Enregistrer
        </Button>
        <Button
          variant="ghost"
